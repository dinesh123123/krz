...
const User = () => {
  ...
  const getHomeData2 = async () => {
    ...
    try {
      const response = await axios.post(
        "https://admin.krazeal.com/krazeal/api/get_user",
        data,
        options
      );
      setLists(response.data.data);
      //console.log("response of orderaaa", response.data.data);
    } catch (err) {
      console.error(err);
    }
  };

  const usered = localStorage.getItem("useriid");
  ...
  const handleFormSubmit = async (event) => {
    ...
    formData.append("userId", usered);

    try {
      const response = await axios.post(
        "https://admin.krazeal.com/krazeal/api/user_profile",
        formData,
        {
          headers: {
  ...
  const handelClick = (event) => {
    ...
    if (!input.email) {
      ...
      axios
        .post(
          "https://admin.krazeal.com/website/update_userdata",
          data,
          options
        )
        .then((res) => {
                ...
                <div className="profile-box">
                  ...
                  <div className="profile-contain">
                    <div className="profile-contain">
                      <div className="profile-image">
                        <div className="position-relative">
                          <img
                            ...
                            src={
                              "https://admin.krazeal.com/uploads/" + lists.image
                            }
                      ...
                      <form onSubmit={handleFormSubmit}>
                        <button
                          ...
                          style={{ background: "white", borderRadius: "19px" }}
                          type="submit"
                        >
                          Updated
                        </button>
                    ...
                    {/* <div class="profile-contain">
                      <div input type="file" class="profile-image">
